...
public class MnistDataFetcherIID extends BaseDataFetcher {
    ...
    public MnistDataFetcherIID(boolean binarize, boolean train, boolean shuffle, long rngSeed) throws IOException {
...
//            totalExamples = this.numExamples;
...
//            validateFiles(files, checksums);
    ...
    @Override
    public void fetch(int numExamples) { //numExample == batchSize
        if (!hasMore()) {
...
//            allData = new MNISTSingleData[numExamples];
        }
